...
final class DeleteCourseControllerFunctionalTest extends WebTestCase
{
    /** @var string */
    public const METHOD = 'DELETE';

    /** @var string */
    public const ENDPOINT = '/-/delete-course';
    ...
    public function testTheUserIsTeacherToDeleteTheCourse(): void
    {
        ErrorResponseTester::assertError(
            static::createClient(),
            $this,
            ...
            '{"id":"04ed0e23-48ec-44f7-8130-5c52666ffa66"}',
            400,
            31,
