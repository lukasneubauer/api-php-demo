...
final class GetLessonControllerFunctionalTest extends WebTestCase
{
    /** @var string */
    public const METHOD = 'GET';

    /** @var string */
    public const ID = '77c76af4-cc32-4695-99cf-41f60b8b7ad3';

    /** @var string */
    public const ENDPOINT_BASE = '/-/get-lesson';
    ...
    public function testOk(): void
    {
        ...
        try {
            ...
            $this->assertSame('2000-01-01 17:00:00', $data['from']);
            $this->assertArrayHasKey('to', $data);
            $this->assertSame('2000-01-01 19:00:00', $data['to']);

            $this->assertArrayHasKey('course', $data);
            $this->assertIsArray($data['course']);
            $this->assertArrayHasKey('id', $data['course']);
            $this->assertSame('6fd21fb4-5787-4113-9e48-44ded2492608', $data['course']['id']);
    ...
    public function testOkWithExpiredApiToken(): void
    {
        ...
        $lessonId = '7dbcdb01-e525-42fa-863c-01bbc1bf5dc0';
        ...
        try {
            ...
            $this->assertArrayHasKey('id', $data);
            $this->assertSame($lessonId, $data['id']);
            $this->assertArrayHasKey('name', $data);
            $this->assertSame('Minulý, přítomný a budoucí čas', $data['name']);
            $this->assertArrayHasKey('from', $data);
            $this->assertSame('2000-01-01 17:00:00', $data['from']);
            ...
            $this->assertIsArray($data['course']);
            $this->assertArrayHasKey('id', $data['course']);
            $this->assertSame('f1f81421-dc6d-4517-9f32-31bdd5c33e0d', $data['course']['id']);
            $this->assertArrayHasKey('name', $data['course']);
            $this->assertSame('Letní doučování angličtiny', $data['course']['name']);
