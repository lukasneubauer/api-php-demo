...
final class CreateCourseSubscriptionControllerFunctionalTest extends WebTestCase
{
    /** @var string */
    public const METHOD = 'POST';

    /** @var string */
    public const ENDPOINT = '/-/create-course-subscription';
    ...
    public function testCannotSubscribeToInactiveCourse(): void
    {
        ErrorResponseTester::assertError(
            ...
            '{"courseId":"e5a5cf65-073e-4920-bdef-1b268951665b"}',
            400,
            26,
    ...
    public function testOkWithExpiredApiToken(): void
    {
        ...
        $apiToken = '27eswk7epa0ebdbrcvaclu0ttp1gtr6bkoradrsv8v4u8kr4ni8apqcisq881yn25gf73mg9yvavdhip';
        ...
        try {
            $client->request(
                ...
                [
                    'HTTP_Api-Key' => $dic->getParameter('api_key'),
                    'HTTP_Api-Client-Id' => 'wkjwrkk3k7ycfh42125bwux2esk58lq5fqudsn7w',
                    'HTTP_Api-Token' => $apiToken,
                ],
                \sprintf('{"courseId":"%s"}', $courseId)
            );
