...
class UploadAvatarRequestValidator
{
    ...
    public function validateRequest(
        ...
        try {
            ...
            $this->requestValidator->checkIfPropertyAvatarIsMissingInRequestBody($data);
            $this->requestValidator->checkIfPropertyAvatarIsOfCorrectDataTypeInRequestBody($data);
            $this->requestValidator->checkIfPropertyAvatarIsNonEmptyStringInRequestBody($data);
            $this->requestValidator->checkIfTryingToUploadAvatarImageOfUnsupportedType($data);
